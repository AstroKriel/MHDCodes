...
## OPERATOR CLASS
## ###############################################################
def plotSimData(filepath_sim_res, add_vel_cmap=False, add_mag_cmap=False):
...
## ###############################################################
def main():
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach0.3/Pm125/288/", add_vel_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach0.3/Pm10/288/", add_mag_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach0.3/Pm5/288/", add_vel_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach0.3/Pm1/288/", add_mag_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach5/Pm125/288/", add_vel_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach5/Pm10/288/", add_mag_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach5/Pm5/288/", add_vel_cmap=True)
  plotSimData(f"{PATH_SCRATCH_EK9}/Rm3000/Mach5/Pm1/288/", add_mag_cmap=True)
