...
def getAveNormKinSpectra(filepath_data):
  plots_per_eddy = LoadFlashData.getPlotsPerTturbFromFlashParamFile(
    f"{filepath_data}/../",
    bool_hide_updates=True
  )
  ## load kinetic energy spectra
  list_kin_k_group_t, list_kin_power_group_t, _ = LoadFlashData.loadListOfSpectraDataInDirectory(
...
def main():
  ...
  plt.savefig(f"{filepath_sim}/kin_spect_comparison.png")
  plt.close()
